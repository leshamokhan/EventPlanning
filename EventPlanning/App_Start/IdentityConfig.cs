...
namespace EventPlanning
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            mail.From = new MailAddress(ConfigurationManager.AppSettings["mailAccount"], "Event Planning");
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            manager.RegisterTwoFactorProvider("Код на телефон", new PhoneNumberTokenProvider<ApplicationUser>
            {
                MessageFormat = "Ваш код безопасности: {0}"
            });
            manager.RegisterTwoFactorProvider("Код на почту", new EmailTokenProvider<ApplicationUser>
            {
